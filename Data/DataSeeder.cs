            ...
            if (!await context.Empleados.AnyAsync())
            {
                ...
                if (deptoTI != null && puestoDevSenior != null)
                {
                    empleados.Add(new Empleado
                    {
                        ...
                        FechaContratacion = new DateTime(2020, 1, 10, 0, 0, 0, DateTimeKind.Utc),
                ...
                if (deptoTI != null && puestoDevJunior != null)
                {
                    empleados.Add(new Empleado
                    {
                        ...
                        FechaNacimiento = new DateTime(1995, 8, 20, 0, 0, 0, DateTimeKind.Utc),
                        FechaContratacion = new DateTime(2022, 3, 15, 0, 0, 0, DateTimeKind.Utc),
                        EstadoLaboral = "ACTIVO",
                ...
                if (deptoRRHH != null && puestoGerenteRRHH != null)
                {
                    empleados.Add(new Empleado
                    {
                        ...
                        FechaNacimiento = new DateTime(1985, 3, 10, 0, 0, 0, DateTimeKind.Utc),
                        FechaContratacion = new DateTime(2018, 6, 1, 0, 0, 0, DateTimeKind.Utc),
                        EstadoLaboral = "ACTIVO",
